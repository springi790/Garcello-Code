...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'headache-neo':
				dialogue = CoolUtil.coolTextFile(Paths.txt('headache-neo/headache-neoDialogue'));
			case 'nerves-neo':
				dialogue = CoolUtil.coolTextFile(Paths.txt('nerves-neo/nerves-neoDialogue'));
			case 'release-neo':
				dialogue = CoolUtil.coolTextFile(Paths.txt('release-neo/release-neoDialogue'));
			case 'fading-neo':
				dialogue = CoolUtil.coolTextFile(Paths.txt('fading-neo/fading-neoDialogue'));
		}
		...
		kadeEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " " + (storyDifficulty == 3 ? "Neo" : storyDifficulty == 2 ? "Hard" : storyDifficulty == 1 ? "Normal" : "Easy") + (Main.watermarks ? " - KE " + MainMenuState.kadeEngineVer : ""), 16);
			...
			switch (SONG.noteStyle)
			{
				...
				case 'normal':
					...
					switch (Math.abs(i))
					{
						...
						case 'neo':
					babyArrow.frames = Paths.getSparrowAtlas('NOTE_assets_neo');
					babyArrow.animation.addByPrefix('green', 'arrowUP');
					babyArrow.animation.addByPrefix('blue', 'arrowDOWN');
					babyArrow.animation.addByPrefix('purple', 'arrowLEFT');
					babyArrow.animation.addByPrefix('red', 'arrowRIGHT');
		...
		if (!boyfriend.stunned)
		{
			...
			switch (direction)
			{
				case 0:
					...
					FlxG.camera.shake(0.01, false, X);
				case 1:
